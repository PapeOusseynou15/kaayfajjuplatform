...
class User extends Component {
  ...
  handlePassword(e) {
    ...
    if (this.checkBtn.context._errors.length === 0) {
      this.props
        .dispatch(
          register(this.state.email, this.state.oldPassword, this.state.newPassword)
        )
        .then(() => {
          history.push("/login");
          ...
          >
            ...
            {!this.state.successful && (
              ...
              <div class="ui left icon input">
                ...
                <div >
                  <button className="ui fluid large blue submit button btn-block">Changer le mot de passe</button>
                </div>
              </div>
